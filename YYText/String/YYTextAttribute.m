...
- (void)setFont:(UIFont *)font {
    ...
    if (font == (id)[NSNull null] || font == nil) {
        ...
        CTFontRef ctFont = CTFontCreateWithName([font.fontName isEqualToString:@".SFUI-Regular"] ? (__bridge CFStringRef)@"TimesNewRomanPSMT":(__bridge CFStringRef)font.fontName, font.pointSize, NULL);
        if (ctFont) {
